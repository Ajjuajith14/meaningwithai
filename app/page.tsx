          ...
          try {
            ...
            if (imageResponse.ok) {
              ...
              setSearchResult((prev) =>
                prev ? { ...prev, image_url: imageData.image_url } : null
              );
            ...
            toast.info(
              "Definition ready! Visual couldn't be generated this time."
            );
          } finally {
          ...
          <div className="text-center space-y-8 max-w-6xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              <p className="text-xl md:text-2xl text-gray-600 font-playful max-w-4xl mx-auto leading-relaxed">
                🌟 Turn every word into a visual adventure! Our AI creates
                beautiful pictures and detailed explanations that make learning
                fun and comprehensive for children.
              </p>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <Card className="shadow-xl rounded-3xl border-2 border-blue-200 hover:shadow-2xl transition-all duration-300 hover:scale-105">
                  <CardHeader className="text-center p-8">
                    ...
                    <CardTitle className="text-xl font-playful text-blue-700">
                      Smart AI Brain
                    </CardTitle>
                    <CardDescription className="font-playful text-blue-600">
                      Our AI creates comprehensive learning cards with
                      pronunciations, definitions, examples, and real-world
                      scenarios - just like having a personal tutor!
                    </CardDescription>
                  </CardHeader>
                </Card>
                ...
                <Card className="shadow-xl rounded-3xl border-2 border-purple-200 hover:shadow-2xl transition-all duration-300 hover:scale-105">
                  <CardHeader className="text-center p-8">
                    ...
                    <CardDescription className="font-playful text-purple-600">
                      Every word comes with a custom-generated, colorful cartoon
                      illustration that helps visualize and remember the meaning
                      better!
                    </CardDescription>
                  </CardHeader>
                </Card>
                ...
                <Card className="shadow-xl rounded-3xl border-2 border-pink-200 hover:shadow-2xl transition-all duration-300 hover:scale-105">
                  <CardHeader className="text-center p-8">
                    ...
                    <CardTitle className="text-xl font-playful text-pink-700">
                      Instant Learning
                    </CardTitle>
                    <CardDescription className="font-playful text-pink-600">
                      Get comprehensive word explanations, pronunciations, and
                      visual aids in seconds! No waiting, just instant
                      educational magic! ⚡
                    </CardDescription>
                  </CardHeader>
                </Card>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="text-center space-y-8 max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold font-playful text-gray-800">
                Ready to Start Learning? 🎓
              </h2>
              <p className="text-lg text-gray-600 font-playful">
                Join thousands of students already expanding their vocabulary
                with AI-powered learning cards!
              </p>
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <Card className="text-center p-6 rounded-2xl border-2 border-green-200 bg-green-50">
                  ...
                  <h3 className="text-lg font-bold font-playful text-green-700 mb-2">
                    Expert-Verified Definitions
                  </h3>
                  <p className="text-green-600 font-playful">
                    All definitions are cross-referenced with trusted
                    dictionaries like Oxford and Merriam-Webster
                  </p>
                </Card>

                <Card className="text-center p-6 rounded-2xl border-2 border-blue-200 bg-blue-50">
                  <BookOpen className="w-12 h-12 mx-auto mb-4 text-blue-600" />
                  <h3 className="text-lg font-bold font-playful text-blue-700 mb-2">
                    Age-Appropriate Content
                  </h3>
                  <p className="text-blue-600 font-playful">
                    Carefully crafted explanations suitable for learners aged
                    6-18, with proper educational context
                  </p>
                </Card>
                ...
                <Card className="text-center p-6 rounded-2xl border-2 border-purple-200 bg-purple-50">
                  ...
                  <h3 className="text-lg font-bold font-playful text-purple-700 mb-2">
                    Comprehensive Learning
                  </h3>
                  <p className="text-purple-600 font-playful">
                    Each word includes pronunciation, part of speech, examples,
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-600 font-playful">
                  Making vocabulary building fun and effective!
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <Card className="text-center p-6 rounded-2xl border-2 border-yellow-200 bg-yellow-50">
                  ...
                  <h3 className="text-lg font-bold font-playful text-yellow-700 mb-2">
                    Easy to Understand
                  </h3>
                  <p className="text-yellow-600 font-playful">
                    Complex words broken down into simple, clear explanations
                    that make sense
                  </p>
                </Card>
                ...
                <Card className="text-center p-6 rounded-2xl border-2 border-green-200 bg-green-50">
                  ...
                  <p className="text-green-600 font-playful">
                    Custom illustrations help students remember and understand
                    word meanings better
                  </p>
                </Card>
                ...
                <Card className="text-center p-6 rounded-2xl border-2 border-orange-200 bg-orange-50">
                  ...
                  <h3 className="text-lg font-bold font-playful text-orange-700 mb-2">
                    Always Expanding
                  </h3>
                  <p className="text-orange-600 font-playful">
                    Unlimited vocabulary exploration with new words and concepts
                    to discover daily
                  </p>
                </Card>
              </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                <div>
                  <div className="text-3xl font-bold text-blue-600 font-playful">
                    5000+
                  </div>
                  <div className="text-gray-500 text-sm font-playful">
                    Happy Students
                  </div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-purple-600 font-playful">
                    100K+
                  </div>
                  <div className="text-gray-500 text-sm font-playful">
                    Words Learned
                ...
                <div>
                  <div className="text-3xl font-bold text-pink-600 font-playful">
                    98%
                  </div>
                  <div className="text-gray-500 text-sm font-playful">
                    Learning Success
                ...
                <div>
                  <div className="text-3xl font-bold text-green-600 font-playful">
                    24/7
                  </div>
                  <div className="text-gray-500 text-sm font-playful">
                    AI Tutor Available
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-4 gap-8">
              <div className="space-y-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xl font-bold font-playful text-gray-800">
                    Visualize Dictionary
                  </span>
                </div>
                <p className="text-gray-600 font-playful">
                  Making vocabulary learning magical with AI technology for
                  students worldwide.
                </p>
              </div>

              <div>
                <h4 className="font-bold font-playful text-gray-800 mb-4">
                  Product
                </h4>
                <div className="space-y-2">
                  <Link
                    href="/pricing"
                    className="block text-gray-600 hover:text-blue-600 font-playful"
                  >
                    Pricing
                  </Link>
                  <Link
            ...
            <div className="border-t mt-8 pt-8 text-center">
              <p className="text-gray-500 font-playful">
                © 2024 Visualize Dictionary. Made with ❤️ for curious young
                minds.
              </p>
            </div>
          </div>
